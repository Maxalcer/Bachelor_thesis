...
# architecture for a big FCNN for matices with size 25x25 with forward propagation, testing and training function
...
class FC_Netz(nn.Module):
  def __init__(self):
    ...
    self.lin2 = nn.Linear(625,625)
    self.lin3 = nn.Linear(625,625)
    self.lin4 = nn.Linear(625,1)
