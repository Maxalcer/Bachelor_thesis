...
# Calculates accuracy when using the heuristic for using bigger matrices

netzfc = torch.load('../saved_nets/saved_fc_netz.py')

netzfc = netzfc.cpu() 

# Calculating the accuracy for the testing data using the heuristic and changing the cutoff
def test_var_noise():
  netzfc.eval()
  hits_fc = 0
  hits_algo = 0
