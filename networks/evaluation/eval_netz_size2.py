...
# Comparing the accuracy for different input sizes with more samples

netz10 = torch.load('../saved_nets/saved_fc_netz.py', map_location=torch.device('cpu'))
netz25 = torch.load('../saved_nets/saved_fc_netz_10x25.py', map_location=torch.device('cpu'))
netz50 = torch.load('../saved_nets/saved_fc_netz_10x50.py', map_location=torch.device('cpu'))
