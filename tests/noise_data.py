...
if (len(train_data_fin) == len(train_data_inf)):
  ...
  write_data("../data/train_fin_noise.txt", train_data_fin)
...
if (len(test_data_fin) == len(test_data_inf)):
  ...
  for inf, fin in zip(test_data_inf, test_data_fin):
  ...
  write_data("../data/test_fin_noise_5.txt", test_noise_5_fin)
  write_data("../data/test_inf_noise_5.txt", test_noise_5_inf)
  write_data("../data/test_fin_noise_15.txt", test_noise_15_fin)
  write_data("../data/test_inf_noise_15.txt", test_noise_15_inf)
  write_data("../data/test_fin_noise_25.txt", test_noise_25_fin)
