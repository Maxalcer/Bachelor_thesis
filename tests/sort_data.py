...
train_data_fin = read_data_mat("../data/25x25/noise/unsorted/train_fin_25x25_noise.txt")
train_data_inf = read_data_mat("../data/25x25/noise/unsorted/train_inf_25x25_noise.txt")
...
write_data("../data/25x25/noise/sorted/train_fin_25x25_noise_sorted.txt", train_data_fin)
write_data("../data/25x25/noise/sorted/train_inf_25x25_noise_sorted.txt", train_data_inf)

del train_data_inf, train_data_fin

test_data_inf_5 = read_data_mat("../data/25x25/noise/unsorted/test_inf_25x25_noise_5.txt")
test_data_fin_5 = read_data_mat("../data/25x25/noise/unsorted/test_fin_25x25_noise_5.txt")
...
write_data("../data/25x25/noise/sorted/test_fin_25x25_noise_5_sorted.txt", test_data_fin_5)
write_data("../data/25x25/noise/sorted/test_inf_25x25_noise_5_sorted.txt", test_data_inf_5)
