...
for i in range(len(test_data_fin_5)):
  ...
  test_data_inf_15[i] = sort_cluster(test_data_inf_15[i])
  test_data_fin_15[i] = sort_cluster(test_data_fin_15[i])
  test_data_inf_25[i] = sort_cluster(test_data_inf_25[i])
  test_data_fin_25[i] = sort_cluster(test_data_fin_25[i])
