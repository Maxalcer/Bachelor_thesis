...
train_data_fin = read_data_mat("../data/train_fin_12x12_noise.txt")
train_data_inf = read_data_mat("../data/train_inf_12x12_noise.txt")
...
write_data("../data/train_fin_12x12_noise_sorted.txt", train_data_fin)
write_data("../data/train_inf_12x12_noise_sorted.txt", train_data_inf)

del train_data_inf, train_data_fin

test_data_inf_5 = read_data_mat("../data/test_inf_12x12_noise_5.txt")
test_data_fin_5 = read_data_mat("../data/test_fin_12x12_noise_5.txt")
...
write_data("../data/test_fin_12x12_noise_5_sorted.txt", test_data_fin_5)
write_data("../data/test_inf_12x12_noise_5_sorted.txt", test_data_inf_5)
